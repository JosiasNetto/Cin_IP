...
if numero == 1:
    ...
    #Aqui se usa o or, pois, pode-se ter dois locais maiores que outro, mas, iguais entre si
    elif len(string_1) == len(string_2) or len(string_1) == len(string_3) or len(string_2 == string_3):
    ...
    elif len(string_1) == len(string_2) or len(string_1) == len(string_3) or len(string_2) == len(string_3):
        print("(Droga! Ainda não consegui descobrir o local que possui mais sinais desconhecidos! Vou ter que ficar mais um tempo nessa Mansão Mal-Assombrada...)")
        achou_lugar = False
...
if not achou_lugar:
    ...
    elif string_1 == string_2 or string_1 == string_3 or string_2 == string_3:
